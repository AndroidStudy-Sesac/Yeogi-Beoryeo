...
앱 이름은 ‘여기버려 소형 가전 무료 수거함 찾기’로, 소형 가전을 무료로 배출할 수 있는 가까운 수거함의 위치를 찾는 기능을 설명합니다. 간단한 설명은 ‘소형 가전을 무료로 버릴 수 있는 내 주변 수거함을 찾아보세요.’로 등록합니다.
