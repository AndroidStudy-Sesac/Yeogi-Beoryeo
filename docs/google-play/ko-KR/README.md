...
가까운 소형 가전 배출 장소를 찾는 기능을 중심으로 앱을 소개합니다. 아래 문구와 이미지를 Google Play 스토어 등록정보의 각 항목에 사용합니다.
...
| 순서  | 이미지                                                        | 소개 내용                              |
| --- | ---------------------------------------------------------- | ---------------------------------- |
| 1   | [01-nearby-free.png](screenshots/01-nearby-free.png)       | 내 주변의 가전 배출 장소를 지도에서 찾습니다.         |
...
‘소형 가전, 버릴 곳을 내 주변에서’라는 문구와 선풍기, 전기밥솥, 헤어드라이어 일러스트로 앱의 핵심 용도를 소개합니다.
